...
@csrf
  <div>
    ...
    <input id="employment" type="text" name="employment" placeholder="例）フリーランス">
  </div>

<div>
    <lavel for="language">使用言語</lavel>
    <input id="language" type="text" name="language" placeholder="例）laravel">
  </div>

  <div>
    <lavel for="location">所在地</lavel>
    <input id="location" type="text" name="location" placeholder="例）長野県長野市">
  </div>

  <div>
    <lavel for="birthday">生年月日</lavel>
    <input id="birthday" type="number" name="birthday" placeholder="例）19940602">
  </div>
